...
public class Model {
    ...
    public void buildOur(){
        try{
            ...
            for(int i=0;i<row;i++){
                our.add(i,new ArrayList<Define.Block>());
                for(int j=0;j<col;j++)
                    our.get(i).add(new Define.Block(Define.UNKNOWN));
            }

            our.get(0).set(1,new Define.Block(Define.BRANCH));
